...
public class DzikirSetelahShalatActivity extends AppCompatActivity {

    private ViewPager mSlideViewPager;
    private LinearLayout mDotLayout;
    private TextView[] mDots;
    private SliderAdapterSetelahShalat sliderAdapterSetelahShalat;
    private Button mBtnNext, mBtnPrevious;
    private int mCurrentPage;
    private GestureFrameLayout mZoom;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dzikir_setelah_shalat);
        setTitle("Dzikir Setelah Shalat");

        setView();

        sliderAdapterSetelahShalat = new SliderAdapterSetelahShalat(this, getLayoutInflater());
        mSlideViewPager.setAdapter(sliderAdapterSetelahShalat);
